...
interface DBObject{
   abstract DBObject initializeIdAndName(long id, String name);
}
...
class Matrix{
    DBObject user1 = new User().initializeIdAndName( 1,"Frankov");
    DBObject user2 = new User().initializeIdAndName(2,"Klyuev");
}
