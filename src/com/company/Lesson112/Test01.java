 ...
 *   * В массиве нет дубликатов. В массиве отсутствует одино из целых чисел. Напишите эффективный код, чтобы найти недостающее целое число.
 * <p>
 * 1 отсортировать массив для порядка элементов
 * 2 создать переменную findeNumbers
 * 3 пройтись фором по массиву
 * 4  записать в переменную findeNumbers
 */
public class Test01 {
